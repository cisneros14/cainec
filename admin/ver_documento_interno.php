...
<main class="min-h-screen p-4 sm:p-6 bg-gray-50">
    ...
    <button onclick="responder(<?php echo $movimiento_id; ?>)" class="flex-1 bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition shadow-lg flex justify-center items-center gap-2">
...
function responder(id) {
    if(!id) return alert("Error: No se detectó el ID del documento");
    // Redirigimos con el parámetro correcto
    window.location.href = 'nuevo_documento.php?reply_to=' + id;
}
</script>