...
<main class="min-h-screen p-0 md:p-6">
    <div class="w-full mx-auto">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Categorías de Junta Directiva</h1>
                <p class="text-gray-500 text-sm mt-1">Administra las categorías disponibles para los miembros</p>
            </div>
...
<!-- MODAL CREAR/EDITAR -->
<dialog id="modalForm" class="backdrop:bg-black/60 backdrop:backdrop-blur-sm p-0 rounded-2xl w-full max-w-md
...
<script>
    ...
    function aplicarFiltros() {
        ...
        const categoriasFiltradas = todasCategorias.filter(cat => {
            return cat.nombre.toLowerCase().includes(filtroNombre);
        });
    ...
    document.getElementById('formCategoria').addEventListener('submit', async (e) => {
        ...
        try {
            const url = id ? 'api/categoriasJunta/editar.php' : 'api/categoriasJunta/crear.php';
            const data = { nombre };
    ...
    async function confirmDelete() {
        ...
        try {
            const response = await fetch('api/categoriasJunta/eliminar.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
